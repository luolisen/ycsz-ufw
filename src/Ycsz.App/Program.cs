...
namespace Ycsz {
    ...
    sealed class HostService : ServiceBase {
        ...
        protected override void OnStart(string[] args) {
            ...
            try { tray=new TraySupervisor(new WindowsInteractiveSessionSource(),new WindowsTrayRuntime(),m=>Store.Log("Tray: "+m)); tray.Start(); }
