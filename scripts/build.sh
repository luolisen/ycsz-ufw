...
mcs -sdk:4.5 -platform:x64 -target:winexe -optimize+ -warnaserror \
  ...
  -r:System.Windows.Forms -r:System.Drawing -r:System.Xml -r:System.Xml.Linq src/Ycsz.App/*.cs
...
shasum -a 256 artifacts/Ycsz-Setup-0.1.0-x64.exe artifacts/app/Ycsz.exe artifacts/app/Ycsz.Core.dll > artifacts/SHA256SUMS
